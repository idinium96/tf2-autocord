...
class Discord(commands.Cog):
    ...
    async def statsAndpolldata(self):
        """A task that at every 6 hours will get trade statistic and current key price,
        also will send polldata.json and pricelist.json as backup daily at 00:01 and 00:02 UTC, respectively."""
        ...
        if self.bot.current_time.split()[1] in ['23:59', '05:59', '11:59', '17:59']:
            ...
            await sleep(30)
            self.bot.s_bot.send_message(f'{self.bot.prefix}price Mann Co. Supply Crate Key')
            await sleep(60)
